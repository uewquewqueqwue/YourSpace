...
const startMonitoring = () => {
  ...
  setTimeout(() => apps.value[0] && checkAppStatus(apps.value[0]), 1000)
}
...
/**
 * Синхронизация с сервера - обновляем только то, что пришло с сервера,
 * но НЕ затираем кастомные имена пользователя
 */
